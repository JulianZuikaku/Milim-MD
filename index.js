...
async function __START() {
    ...
    const sock = sockConnect({
        ...
        browser: ['Milim Multi Device','Safari','1.0.0'],
        auth: state,
        version
    })
...
console.log(color(`█████████████████████████\n█▄─▄▄▀█▄─▄▄─█▄─▄▄─█▄─▄▄─█\n██─██─██─▄█▀██─▄████─▄███\n▀▄▄▄▄▀▀▄▄▄▄▄▀▄▄▄▀▀▀▄▄▄▀▀▀`)) 
const users = [
		{Creator: 'Julian', Whatsapp: 62887433094409, NameBot: global.namebot, Versi: 7 }
		];
		console.table(users)


sock.browserDescription = ["MILIM-MD", "Mac", "3.0.0"];
